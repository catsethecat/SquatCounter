...
- Install the Beat Saber plugin (from [Releases](https://github.com/catsethecat/SquatCounter/releases) or build it manually)
- Add a Browser source to OBS and set the URL to http://catse.net/squatcount  
...
## Configuration
In case you want to make adjustments to the squat detection behaviour here's an explanation of the config file.  
The default config `UserData\SquatCounter.json` looks something like this:  
```
{  
